...
public:
    ...
    void printfArr(std::vector<int> stack) {
    ...
    bool dfs() {
        while (!_stack.empty()) {
            ...
            printf("1111:%d;", node.index);
            printf("2222:%d;\n", node._nestedList.size());
...
//                Node node1 = {node._nestedList, node.index + 1};
...
int main() {
    ...
    NestedInteger in1 = NestedInteger(list, 11);
    NestedInteger in2 = NestedInteger(list, 12);
    std::vector<NestedInteger> list1;
    list1.push_back(in1);
    list1.push_back(in2);

    NestedInteger in3 = NestedInteger(list, 13);
    NestedInteger in4 = NestedInteger(list, 14);
    std::vector<NestedInteger> list2;
    list2.push_back(in3);
    list2.push_back(in4);

    NestedInteger in5 = NestedInteger(list1, 15);

    NestedInteger in6 = NestedInteger(list, 16);
